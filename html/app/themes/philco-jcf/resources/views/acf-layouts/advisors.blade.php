<div
  class="layout-block__advisors position-relative
...
>
  <div
    class="parallax-badge d-none d-md-block"
    data-enllax-ratio="-0.1"
  ></div>
  <div class="container">
    <div class="row justify-content-between">
      ...
      <div class="col-12 text-center text-lg-left">
        ...
        @include(
            'partials.acf-link',
            array_merge($area['link'], ['class' => 'link-dark-turquoise link-underline ml-lg-5']))
      </div>
    </div>
  </div>
</div>
