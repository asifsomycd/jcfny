...
export default {
  ...
  finalize() {
    ...
    changeFormStep(
      typeof urlParameters.dev_form_page !== 'undefined'
        ? urlParameters.dev_form_page - 1
        : 0
    )
    ...
    $('.form__app').on(
      'click',
      '.add-another__button, .add-another label',
      function() {
